...
<title>View Water Inventory</title>
...
<main class="main">
		...
		<div class="content__inner top-thick-border grey lighten-4">
			...
			<div class="breadcrumb_container ml-4">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="#"> Water Inventory </a></li>
					<li class="breadcrumb-item"><a href="#">View Water Inventory </a></li>
				</ol>
			</div>
			<!-- breadcrumb end -->
			...
			<div class="container">
				...
				<h5>View Water Inventory </h5>
					<div id="str"></div>
				</blockquote>
				
				<div id="accordionStack" class="bs-example">
				    <h3>WaterSource</h3>
					<div id="dataWaterSource">
				    </div>
					 
			     	<h3>DirectUse</h3>
					<div id="dataDirectUse">
					</div>
	...
	<script type="text/javascript"
			src="../newAssets/projectscripts/add-filter-use-data.js"></script>
