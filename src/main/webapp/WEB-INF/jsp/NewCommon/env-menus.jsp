...
<%
   ...
   urlstring.add("prefilter"); //13
   urlstring.add("waste_water_treatment"); //14
   urlstring.add("waste_water_treatment_use"); //15
	...
	<div class="scrollbar-inner">
		...
		<ul class="navigation">
			...
			<li class="navigation__sub"><a href=""><i
					...
					class="zmdi zmdi-plus float-right"></i></a>
				<ul>
					<li><a href="create-consent"> <i
							class="zmdi zmdi-comment-edit zmdi-hc-fw"></i> Add
					</a></li>
					<li class="navigation__sub"><a href=""><i
							class="zmdi zmdi-view-list zmdi-hc-fw"></i> View <i
							class="zmdi zmdi-plus float-right"></i></a>
						<ul>
					...
					<li class="navigation__sub"><a href=""><i
							class="zmdi zmdi-view-list zmdi-hc-fw"></i> Water Inventory <i
							class="zmdi zmdi-plus float-right"></i></a>
						<ul>
							<li><a href="add-water-inventory"> <i
									class="zmdi zmdi-comment-edit zmdi-hc-fw"></i> Add
							</a></li>
							<li><a href="view-water-inventory"> <i
									class="zmdi zmdi-view-headline zmdi-hc-fw"></i> View
							</a></li>
						</ul> <a href=""><i class="zmdi zmdi-view-list zmdi-hc-fw"></i>
							WasteWater Treatment <i class="zmdi zmdi-plus float-right"></i></a>
						<ul>
							<li><a href="add-wastewater-treatment"> <i
									class="zmdi zmdi-comment-edit zmdi-hc-fw"></i> Add
							</a></li>
							<li><a href="view-wastewater-treatment"> <i
									class="zmdi zmdi-view-headline zmdi-hc-fw"></i> View
							</a></li>
						</ul></li>
				</ul></li>
			<li class="navigation__sub"><a href=""><i
					class="zmdi zmdi-border-color zmdi-hc-fw"></i> Daily Data <i
					class="zmdi zmdi-plus float-right"></i></a>
				<ul>
					<li><a href="regular-daily-data"> <i
							class="zmdi zmdi-comment-edit zmdi-hc-fw"></i> Add Daily Data
					</a></li>
					<li><a href="view-regular-data"> <i
							class="zmdi zmdi-view-list zmdi-hc-fw"></i> View Daily Data
					</a></li>
					<li><a href="view-modified-data"> <i
							class="zmdi zmdi-view-list zmdi-hc-fw"></i> View Modified Data
					</a></li>
				</ul></li>
			...
			<li class="navigation__sub"><a href=""><i
				...
				<ul>
					<li class="navigation__sub"><a href=""><i
						...
						<ul>
							<li><a onclick="makeMonthlyEsrPopUP()"> <i
					...
					<li class="navigation__sub"><a href=""><i
							...
							Manifest <i class="zmdi zmdi-plus float-right"></i></a>
						<ul>
							<li><a href="HWManifest-form"> <i
									class="zmdi zmdi-plus-circle-o zmdi-hc-fw"></i> Add
							</a></li>
			...
			<li class="navigation__sub"><a href=""><i
				...
				<ul>
					...
					<li><a href="waterConsumption?wc=<%=urlencpt.get(13)%>"><i
							class="zmdi zmdi-view-headline zmdi-hc-fw"></i> Pre-Filter</a></li>
					<li><a href="waterConsumption?wc=<%=urlencpt.get(14)%>"><i
							class="zmdi zmdi-view-headline zmdi-hc-fw"></i> WWTP</a></li>
					<li><a href="waterConsumption?wc=<%=urlencpt.get(15)%>"><i
							class="zmdi zmdi-view-headline zmdi-hc-fw"></i> WWTP Use</a></li>
				</ul></li>
