...
<body data-ma-theme="blue" class="body-bg">
	<main class="main">
			...
			<div class="content__inner top-thick-border grey lighten-4">
				<header class="content__title">
					<blockquote class="blockquote">
						<h4 class="mb-0">ESR Monthly Form</h4>
					</blockquote>
					<div class="actions">
				...
				<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<input type="hidden" id="working_days"
										value="${companyData.noWorkDays}"> <input
										type="hidden" id="working_hr"
										value="${companyData.workingHour}"> <input type="text"
										class="form-control" required name="Finyear"
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<input type="text" class="form-control" required
											name="Finyear" value="${companyData.indPrimary}" disabled>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<input type="text" class="form-control" required
											name="pincode" value="${companyData.pincode}" disabled>
									</div>
								</div>
							</div>
							<div class="col-sm-4"></div>
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<input type="text" class="form-control" required
											name="perName" value="${companyData.contPerName}" disabled>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<input type="hidden" id="company_category"
											value="${companyData.industryCategory}"> <input
											type="text" class="form-control" required name="fax"
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<c:forEach items="${issueDateList}" var="Inssdate"
											varStatus="loop">
											<input type="text" class="form-control" required name="fax"
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="fg-line">
										<c:forEach items="${validUptoList}" var="Validdate"
											varStatus="loop">
											<input type="text" class="form-control" required name="fax"
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<h5>
								1) Water Consumption in m<sup>3</sup>/day
								<h5>
						</div>
						<table class='table table-bordered normal formatted-padding'>
							<thead>
								<tr>
									...
									<th>Actual Quantity in m<sup>3</sup>/day
									</th>
								</tr>
							</thead>
							<tbody id="water_info">
					...
					<div class="row">
						<div class="col-sm-12 mt-4">
							<h5>
								1)Effluent Generation in CMD / MLD
								<h5>
						</div>
						<table class='table table-bordered normal formatted-padding'>
							<thead>
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<button class="btn btn-primary btn--icon-text float-right"
								id="esrmonthly_product_water_consumption_button"
								onclick="saveProductMonthESR()">
					...
					<div class="row">
						<div class="col-sm-12 mt-4">
							<h5>
								3) Raw Material Consumption (Consumption of raw material per
								unit of product):
								<h5>
						</div>
						<table class='table table-bordered normal formatted-padding'>
						...
						<div class="col-sm-12">
							<button class="btn btn-primary btn--icon-text float-right"
								id="esrmonthly_product_rawmaterial_button"
								onclick="saveRawMaterialMonthESR()">
								<i class="zmdi zmdi-save"></i> Save
							</button>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12 mt-4">
							<h5>
								Pollution discharged to environment/unit of output (Parameter as
								specified in the consent issued)
								<h5>
						</div>
						<div class="col-sm-12 mt-4">
							<h5>
						...
						<table class='table table-bordered normal formatted-padding'>
							<thead>
								<tr>
									...
									<th>Concentration of Pollutants discharged(Mg/Lit) Except
										PH,Temp,Color.</th>
									<th>Percentage of variation from prescribed standards with
										reasons</th>
								</tr>
								<tr>
									<th></th>
							...
							<tbody id="esr-div-effluent-pollutant">
								<tr>
									<th colspan="2" class="font-weight-900">Effulant
										POLLUTANTS</th>
								</tr>
							</tbody>
							<tbody id="esr-div-sewage-pollutant">
								<tr>
									<th colspan="2" class="font-weight-900">Sewage POLLUTANTS</th>
								</tr>
							</tbody>
						</table>
						...
						<div class="col-sm-12">
							<button class="btn btn-primary btn--icon-text float-right"
								id="effSaveMonthly" onclick="saveEffSewResonMothly()">
								<i class="zmdi zmdi-save"></i> Save
							</button>
						</div>
						...
						<div class="col-sm-12">
							<button class="btn btn-primary btn--icon-text float-right"
								id="airSaveMonthly" onclick="saveAirSewResonMothly()">
								<i class="zmdi zmdi-save"></i> Save
							</button>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="row" id="appendContainers">
								<div class="col-3">
									<div class="form-group">
										<input type="text" name="WasteName[]" class="form-control"
		...
		<script type="text/javascript"
			src="../newAssets/projectscripts/esr-Monthly.js"></script>
	</main>
</body>
</html>