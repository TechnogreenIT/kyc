...
<footer id="footer">
	Copyright &copy; 2018 Technogreen Environmental Solutions <input
		type="hidden" value="${sessionIndustryType}" id="isproduction">
	<input type="hidden" value="${industryCat}" id="industryCat">
	<ul class="f-menu">
		<li><a href="#">Home</a></li>
...
<div class="page-loader">
	<div class="preloader pls-blue">
		<img src='../img/loader_data.webp' height='100px'>
