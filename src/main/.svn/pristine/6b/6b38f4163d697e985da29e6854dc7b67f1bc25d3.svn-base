...
<body data-ma-theme="blue" class="body-bg"
		...
		<div class="content__inner top-thick-border grey lighten-4">
			...
			<div class="container">
				<blockquote class="blockquote">
					<h5 class="mb-0">View Modified Data</h5>
				</blockquote>
				<!--  <div  class="card">
					<div class="card-body"">
					 </div>
	...
	<sec:authorize access="hasRole('ROLE_ENVROFFICER')">
		<script src="../newAssets/projectscripts/ViewModifiedDataJs.js"
			type="text/javascript"></script>
	</sec:authorize>
	
	 <sec:authorize access="hasRole('ROLE_MANAGEMENT')">
		<script src="../newAssets/projectscripts/Man-ViewModifiedDataJs.js"
			type="text/javascript"></script>
	</sec:authorize>
