<div class="row mt-4">
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" name="gen[]" id="domes_gen"
				onchange="javascript:genSum(this);" value="${domesticGen}">
			<div class="invalid-feedback">Required !</div>
			<i class="form-group__bar"></i>
		</div>
	</div>
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" name="gen[]" class="form-control" id="biodeg_gen"
				onchange="javascript:genSum(this);" value="${biodegradableGen}">
			<div class="invalid-feedback">Required !</div>
			<i class="form-group__bar"></i>
		</div>
	</div>
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" name="gen[]" class="form-control" id="ind_gen"
				onchange="javascript:genSum(this);" value="${coolingGen}">
			<div class="invalid-feedback">Required !</div>
			<i class="form-group__bar"></i>
		</div>
	</div>
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" name="gen[]" class="form-control" id="Others_gen"
				onchange="javascript:genSum(this);" value="${otherGen}">
			<div class="invalid-feedback">Required !</div>
			<i class="form-group__bar"></i>
		</div>
	</div>
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="dcRes"
				value="${totalSewCon}" disabled>
		</div>
	</div>
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="dgRes"
				value="${totalSewGen}" disabled>
		</div>
	</div>
	<!-- purpose 6 -->
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="ecRes"
				value="${totalEffCon}" disabled>
		</div>
	</div>
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="egRes"
				value="${totalEffGen}" disabled>
		</div>
	</div>
	<!-- purpose 7 -->
	...
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="cRes" value="${totalCon}"
				disabled>
		</div>
	</div>
	<div class="col-2">
		<div class="form-group">
			<input type="text" class="form-control" id="gRes" value="${totalGen}"
				disabled>
		</div>
	</div>
	<!-- purpose 8 -->
...
<div class="row mt-4 mb-4">
	<div class="col text-center">
		<button type="button" class="btn btn-primary btn-sm"
			onclick="saveConGenData(this,'waterConGen');"
