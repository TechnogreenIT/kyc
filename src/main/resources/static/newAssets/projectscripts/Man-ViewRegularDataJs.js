			 ...
			 for(var i = 0 ;i<objSize;i++){
				...
				if(pType == "hwp"){
				 ...
				 var html1 = "<h3><a href='#'>" + PType  + "</a></h3>" +
					...
					"<table class='table table-bordered'> <thead> <tr> <th>SR. NO.</th> <th>Product Name</th> <th>Quantity</th> <th>Date</th> </tr> </thead> " +
					"<tbody>";
				 var j = 1;
				  $.each(allDataArray, function (index, element) {
					...
					//var regId = element
					html1 +=  "<tr> <td>"+ j +"</td> <td>"+ itemName +"</td> <td>" + cQuantity + "</td> <td>"+ inpDate +"</td> </tr>";
		 			j++; 
				  });
