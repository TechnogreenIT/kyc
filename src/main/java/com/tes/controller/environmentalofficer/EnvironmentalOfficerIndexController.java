...
public class EnvironmentalOfficerIndexController extends BaseEnvironmentOfficerController
{
	...
	private static final Logger LOGGER = LogManager.getLogger(EnvironmentalOfficerIndexController.class);
	...
	public ModelAndView EnvrDashboard(HttpServletRequest request) throws IOException, ServletException, ParseException
	{
		...
		try
		{
			...
			esrHwSolidHazardousWasteList = esrHwSolidWasteServices.findOneByGetHazardousWasteByYear(forYear, "Hazardous Waste");
